...
# not working
# Step 1: Check unique labels in y_true
unique_labels_y_true = np.unique(y_true)
print("Unique Labels in y_true:", unique_labels_y_true)

# Step 2: Compare with labels specified in the confusion matrix
if all(label in unique_labels_y_true for label in labels):
    ...
    print("Error: At least one label specified in 'labels' is not present in 'y_true'.")
